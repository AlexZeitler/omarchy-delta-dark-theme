# omarchy-delta-dark-theme

![Delta Dark](assets/preview.png)

A dark Omarchy theme built from the Group A rally livery of the Lancia Delta
Integrale: a deep navy ground carrying the three stripes in red, light blue
and dark blue.

The palette is deliberately narrow. Every slot the terminal needs holds either
a red, a blue or a blue-grey. Orange and magenta are softer and bluer steps of
the red, green sits between the two blues, and yellow has no counterpart in
the livery at all and is a blue-grey. Warnings are therefore not yellow, and
`git diff` marks additions in blue.

The light counterpart is
[omarchy-delta-light-theme](https://github.com/AlexZeitler/omarchy-delta-light-theme).
...
```bash
omarchy theme install https://github.com/AlexZeitler/omarchy-delta-dark-theme
```
...
|-------------|-----------|---------------------------|
| Background  | `#06182F` | dark blue stripe, deepest |
| Surfaces    | `#123258` | dark blue stripe          |
| Foreground  | `#DDE5F2` | body panels               |
| Accent      | `#6CACE4` | light blue stripe         |
| Red         | `#F5384F` | red stripe                |
| Blue        | `#4587DD` | dark blue stripe, lifted  |
| Blue-grey   | `#8A9DB5` | stands in for yellow      |
...
[![Lancia Delta in a dark studio](assets/01-studio-dark-4k-thumb.jpg)](backgrounds/01-studio-dark-4k.png)

### Studio, light

[![Lancia Delta in a light studio](assets/02-studio-light-4k-thumb.jpg)](backgrounds/02-studio-light-4k.png)

### Omarchy, dark

[![Omarchy wordmark on a dark wall](assets/03-dark-4k-thumb.jpg)](backgrounds/03-dark-4k.png)

### Omarchy, light

[![Omarchy wordmark on a light wall](assets/04-light-4k-thumb.jpg)](backgrounds/04-light-4k.png)
...
ln -s ~/.config/omarchy/themes/delta-dark/hooks/gtk \
...
~/.config/omarchy/themes/delta-dark/hooks/gtk --remove
```
